...
_SAMPLE_PATHS = {
        ...
        'rgb': '/home/david/Documents/code/bits-and-bobs/rgb.npy',
        'flow': '/home/david/Documents/code/bits-and-bobs/flow.npy'
...
_CHECKPOINT_PATHS = {
        ...
        'flow': '/dev/shm/ucf101_I3D/flow/train1/model.ckpt-5000',
        'rgb': '/dev/shm/ucf101_I3D/rgb/train1/model.ckpt-5000'
...
def main(unused_argv):
  ...
  kinetics_classes = open('classes.txt').read().splitlines()
...
'Conv2d').replace('conv_3d/w','weights').replace('conv_3d/b',
